...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        LedgerEntry.objects.update_or_create(customer=customer_map['C-105'], reference='INV-2026-1164', defaults={'entry_type':'Invoice','amount':124600,'entry_date':date(2026,8,18),'due_date':date(2026,9,18),'note':'Opening demo receivable'})
        LedgerEntry.objects.update_or_create(customer=customer_map['C-102'], reference='INV-2026-1171', defaults={'entry_type':'Invoice','amount':38400,'entry_date':date(2026,8,9),'due_date':date(2026,9,9),'note':'Opening demo receivable'})
