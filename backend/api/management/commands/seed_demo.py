...
from api.models import Customer, Invoice, Order, Product, Profile, Supplier, PurchaseOrder, PurchaseItem, GoodsReceipt, LedgerEntry, Warehouse, StockBalance, StockTransfer, StockTransferItem, BarcodeScanLog, WhatsAppMessage, WhatsAppOrderDraft, TaxNote, PriceList, PriceRule, StockAdjustment, ReturnOrder, ReturnItem
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        LedgerEntry, Warehouse, StockBalance, StockTransfer, StockTransferItem, BarcodeScanLog, WhatsAppMessage, WhatsAppOrderDraft, TaxNote, PriceList, PriceRule, StockAdjustment, ReturnOrder, ReturnItem.objects.update_or_create(customer=customer_map['C-105'], reference='INV-2026-1164', defaults={'entry_type':'Invoice','amount':124600,'entry_date':date(2026,8,18),'due_date':date(2026,9,18),'note':'Opening demo receivable'})
        LedgerEntry, Warehouse, StockBalance, StockTransfer, StockTransferItem, BarcodeScanLog, WhatsAppMessage, WhatsAppOrderDraft, TaxNote, PriceList, PriceRule, StockAdjustment, ReturnOrder, ReturnItem.objects.update_or_create(customer=customer_map['C-102'], reference='INV-2026-1171', defaults={'entry_type':'Invoice','amount':38400,'entry_date':date(2026,8,9),'due_date':date(2026,9,9),'note':'Opening demo receivable'})
